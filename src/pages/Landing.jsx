                          ...
                          <div className="col mb-5">
                            ...
                            <div className="card-body p-4">
                              <div className="text-center">
                                <h5 className="fw-bolder">{items.title.slice(0,10)}....</h5>
                                {items.price}
                              </div>
                            </div>

                            <div className="card-footer p-4 pt-0 border-top-0 bg-transparent d-flex justify-content-between">
                              <button className='btn' onClick={()=>(dispatch(addToWishlist(items)))}>
                                <i className="fa-solid fa-heart-circle-plus" style={{ color: '#801b14' }}></i>
                              </button>
                              <button className='btn'onClick={()=>(dispatch(addToCart(items)))}>
                                <i className="fa-solid fa-cart-plus" style={{ color: '#101451' }}></i>
                              </button>
                            </div>
                            </div>
                          </div>
